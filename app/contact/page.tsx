...
import { Mail, MessageSquare, MapPin, Phone, Globe, Send } from "lucide-react"
              ...
              <div className="space-y-6 mb-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">
                      <a href="mailto:info@codemorph.ai" className="hover:text-emerald-400 transition-colors">
                        info@codemorph.ai
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">
                      <a href="tel:+1-800-CODE-MORPH" className="hover:text-emerald-400 transition-colors">
                        +1-800-CODE-MORPH
                      </a>
                    </p>
                  </div>
